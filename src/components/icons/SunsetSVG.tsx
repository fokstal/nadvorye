...
const SunsetSVG = forwardRef<SVGSVGElement>(({ ...props }, ref) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" ref={ref} {...props}>
            ...
            />
            <path fill="#FFB65A" d="M105.55 81.2h2.88v3.94h-2.88zm5.75 0h2.88v3.94h-2.88z" />
            ...
            />
            <path fill="#FECE60" d="M49.8 64.51h2.27v4.76H49.8zm5.38 0h2.27v4.76h-2.27zm5.18 0h2.27v4.76h-2.27z" />
            <path fill="#FE7A47" d="M49.8 97.7h2.27v4.76H49.8zm5.38 0h2.27v4.76h-2.27zm5.18 0h2.27v4.76h-2.27z" />
            <path fill="#FCB757" d="M49.8 73.51h2.27v4.76H49.8zm5.38 0h2.27v4.76h-2.27zm5.18 0h2.27v4.76h-2.27z" />
            <path fill="#FE9C51" d="M49.8 82.51h2.27v4.76H49.8zm5.38 0h2.27v4.76h-2.27zm5.18 0h2.27v4.76h-2.27z" />
            <path
                fill="#FDCB61"
                d="M54.01 53.96h4.66v-6.92s.17-2.6-2.35-2.66c-2.37-.06-2.4 2.6-2.4 2.6s.15 6.98.09 6.98z"
            />
            <path fill="#FFCF62" d="M79.85 64.16h2.27v9.69h-2.27zm8.51 0h2.27v9.69h-2.27zm-4.21 0h2.27v9.69h-2.27z" />
            <path fill="#FEB359" d="M76.37 77.58h2.27v3.09h-2.27zm7.82 0h2.27v3.09h-2.27zm7.82 0h2.27v3.09h-2.27z" />
            <path fill="#FF9A4F" d="M76.37 87.58h2.27v3.09h-2.27zm7.82 0h2.27v3.09h-2.27zm7.82 0h2.27v3.09h-2.27z" />
            <path fill="#FF844B" d="M76.37 97.03h2.27v3.09h-2.27zm7.82 0h2.27v3.09h-2.27zm7.82 0h2.27v3.09h-2.27z" />
            <path fill="#FF7942" d="M76.37 107.03h2.27v3.09h-2.27zm7.82 0h2.27v3.09h-2.27zm7.82 0h2.27v3.09h-2.27z" />
            <path fill="#FC7544" d="M76.37 116.5h2.27v3.09h-2.27zm7.82 0h2.27v3.09h-2.27zm7.82 0h2.27v3.09h-2.27z" />
            <path
                fill="#FFF6B2"
                d="m23.11 49.174l2-.007l.06 18.65l-2 .007zm-7.012-20.688h2v39.39h-2zm86.206 34.865l.006-2l11.86.036l-.006 2z"
            />
            <path
                fill="#FFF6B2"
