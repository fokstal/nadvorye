...
const MoodGoodSVG = forwardRef<SVGSVGElement, IComponentSVG>(({ fill = " #ACE5EE", ...props }, ref) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" ref={ref} {...props}>
            ...
            <path
                fill={fill}
                d="M152 200h40v40h-40zm168 0h40v40h-40zm-64 184a104 104 0 0 0 104-104H152a104 104 0 0 0 104 104Z"
            />
        </svg>
    );
});

export default MoodGoodSVG;
